...
/**
 * Carrier Akagi mob (hostile) entity.
 */
public class EntityCarrierAkagiMob extends BasicEntityShipHostileCV {
    ...
    public EntityCarrierAkagiMob(EntityType<? extends EntityCarrierAkagiMob> type, Level level) {
        super(type, level);
        ...
        // boss bar color
        this.bossBarColor = BossEvent.BossBarColor.RED;
    ...
    public void setAIList() {
        super.setAIList();
        // Legacy hostile Akagi launches aircraft at the carrier goal priority.
